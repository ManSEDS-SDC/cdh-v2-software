...
void PeriphCommonClock_Config(void)
{
  ...
  */
  PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_USB|RCC_PERIPHCLK_I2C4
                              |RCC_PERIPHCLK_SPI6|RCC_PERIPHCLK_ADC
                              |RCC_PERIPHCLK_I2C2|RCC_PERIPHCLK_SDMMC
...
static void MX_FDCAN2_Init(void)
{
  ...
  hfdcan2.Init.NominalTimeSeg1 = 95;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PG3 PG6 PG7 PG10
                           PG11 */
...
void MPU_Config(void)
{
  ...
  */
  ...
  MPU_InitStruct.SubRegionDisable = 0x88;
